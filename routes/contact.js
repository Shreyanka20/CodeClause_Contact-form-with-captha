...
router.post('/contact', [
    ...
    verifyRecaptcha(req.body["g-recaptcha-response"], function(success) {
        ...
        let transporter = nodemailer.createTransport({
            ...
            auth: {
                user: 'itsritwik26@gmail.com', // generated ethereal user
                pass: 'ritwikisgreat@28' // generated ethereal password
            },
            tls: {
            ciphers:'SSLv3'
            }
        ...
        let mailOptions = {
            from: '"Nodemailer Contact" <EMAIL ADDRESS>', // sender address
            to: 'ritwiks.ug21.cs@nitp.ac.in', // list of receivers
    ...
    var SECRET = "6LePPMEmAAAAAC141VwCedGdc0Dgh9tl6IHv9VII";
